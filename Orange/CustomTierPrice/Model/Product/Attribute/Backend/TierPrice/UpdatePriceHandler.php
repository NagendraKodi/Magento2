...
namespace Orange\CustomTierPrice\Model\Product\Attribute\Backend\TierPrice;
...
class UpdatePriceHandler extends AbstractHandler
{
		   ...
		   if ((!empty($value['value']) && (float)$oldValues[$key]['price'] !== (float)$value['value'])
			   ...
			   $price = new \Magento\Framework\DataObject(
				   [
					   ...
					   'priceexcludingtax' => $this->getSecondaryUnit($value),
				   ]
			   );
	...
	*/
	public function getAdditionalFields(array $objectArray): array
	{
	   ...
	   return [
		   ...
		   'priceexcludingtax' => $this->getSecondaryUnit($objectArray),
	   ];
	}
	...
	*/
	...
	{
	   return isset($priceRow['priceexcludingtax']) && !empty($priceRow['priceexcludingtax'])
		   ? $priceRow['priceexcludingtax']
		   : null;
	}
